...
namespace SkillForge.Infrastructure.Migrations
{
    ...
    [Migration("20250429143028_AddCourseTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillForge.Domain.Entities.CourseTag", b =>
                {
                    b.Property<Guid>("CourseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SkillForge.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SkillForge.Domain.Entities.CourseTag", b =>
                {
                    ...
                    b.HasOne("SkillForge.Domain.Entities.Tag", "Tag")
                        .WithMany("CourseTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
